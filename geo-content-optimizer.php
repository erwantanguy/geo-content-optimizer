...
define('GCO_VERSION', '1.2.1');
define('GCO_PATH', plugin_dir_path(__FILE__));
define('GCO_URL', plugin_dir_url(__FILE__));

require_once GCO_PATH . 'vendor/plugin-update-checker/plugin-update-checker.php';

use YahnisElsts\PluginUpdateChecker\v5\PucFactory;

$gcoUpdateChecker = PucFactory::buildUpdateChecker(
    'https://dl.ticoet.me/downloads/pluginsWP/geo-content-optimizer/details.json',
    __FILE__,
...
require_once GCO_PATH . 'includes/class-api.php';
